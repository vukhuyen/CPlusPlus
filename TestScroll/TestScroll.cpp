...
BOOL CTestScrollApp::InitInstance()
{
	...
	m_hMDIMenu  = ::LoadMenu(hInst, MAKEINTRESOURCE(IDR_TESTSCTYPE));
	m_hMDIAccel = ::LoadAccelerators(hInst, MAKEINTRESOURCE(IDR_TESTSCTYPE));
...
void CTestScrollApp::OnFileNew() 
{
	...
	pFrame->CreateNewChild(
		RUNTIME_CLASS(CChildFrame), IDR_TESTSCTYPE, m_hMDIMenu, m_hMDIAccel);
}
